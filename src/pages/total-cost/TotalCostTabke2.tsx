...
export const columns = [
	...
	{ name: 'S.NO', uid: 'date', sortable: true },
	{ name: 'Xarajatlar', uid: 'xarajat' },
	{ name: 'narx', uid: 'narx' },
	{ name: 'Umumiy holat', uid: 'umumiyholat' },
];
...
const INITIAL_VISIBLE_COLUMNS = ['date', 'xarajat', 'narx', 'umumiyHolat'];
...
export default function TotalCostTable2() {
