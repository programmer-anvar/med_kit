...
import TotalCostTabke1 from './TotalCostTabke1';
...
const TotalCost: React.FC = () => {
	return (
		<div className="">
			...
			<div className="grid grid-cols-6 gap-[70px] mt-9 ">
				<div className="w-[230px] h-[139px] bg-white p-8 rounded-lg hover:bg-[#E4E3E3]">
					<div className="flex items-center justify-between">
						<div className="w-[40px] h-[40px] flex items-center justify-center bg-yellow-500 rounded-[50%]">
							<FaUserDoctor />
						</div>
						<p className="text-[#0E1726] text-[14px]">Ishchilar oyligi</p>
					</div>
					<h3 className="text-[#0E1726] text-[30px]">$20,000</h3>
				</div>
				<div className="w-[230px] h-[139px] bg-white p-8 rounded-lg hover:bg-[#E4E3E3]">
					<div className="flex items-center justify-between">
						<div className="w-[40px] h-[40px] flex items-center justify-center bg-yellow-500 rounded-[50%]">
